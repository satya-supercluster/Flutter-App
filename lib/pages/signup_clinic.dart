...
import 'package:meuseum_guide/widgets/common/clinic_input.dart';

class SignUpClinic extends StatefulWidget {
  const SignUpClinic({super.key});

  @override
  State<SignUpClinic> createState() => _SignUpClinicState();
}

class _SignUpClinicState extends State<SignUpClinic> {
  @override
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(height:10),
                        InputData(hintText:"Confirm Password",prefixIcon: Icons.lock,isPasswordField: true,),
                      ],
                    ),
                    SizedBox(height: 80,),
                    Column(
